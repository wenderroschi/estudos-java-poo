...
public class Video implements AcoesVideo {
    ...
    public void setReproduzindo(boolean rep) { this.reproduzindo = rep; }
    
    @Override public void play() { this.reproduzindo = true; }
    @Override public void pause() { this.reproduzindo = false; }
    @Override public void like() { this.curtidas++; }
